...
double WATCHDOG_INTERVAL = 500000;
...
bool initMPU(){
	...
	mpu.useMagCal(true);
	return mpu.init(MPU_UPDATE_RATE, 5, MAG_UPDATE_RATE, MPU_LPF_RATE);   // start the MPU
}
